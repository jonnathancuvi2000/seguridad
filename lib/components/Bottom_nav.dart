    ...
    return Container(
        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            items: const [
              BottomNavigationBarItem(icon: Icon(Icons.emergency_recording), label: 'Emergen'),
              BottomNavigationBarItem(
                  icon: Icon(Icons.camera_front), label: 'Dispositivos'),
              BottomNavigationBarItem(
                  icon: Icon(Icons.manage_accounts), label: 'Usurios'),
              BottomNavigationBarItem(
